...
const CONFIG = {
  ...
  PACKAGES: {
    "vintage-tirai": {
      ...
      photo: "images/background/vintage.JPG",
      backgrounds: ["Vintage & Tirai Box"],
      pkgs: {
    ...
    "elevator": {
      label: "Elevator Box",
      photo: "images/background/elevator.jpg",
    ...
    "retro": {
      label: "Retro Room",
      photo: "images/background/retroroom.JPG",
    ...
    "color": {
      ...
      photo: "images/background/color.png",
  ...
  // Maps each individual background name (as listed in PACKAGES[...].backgrounds)
  // to its photo, used by the Booking page to preview the chosen background.
  BACKGROUND_PHOTOS: {
    "Vintage & Tirai Box": ["images/background/vintage.JPG", "images/background/tirai.JPG"],
    "Elevator Box": "images/background/elevator.jpg",
    "Retro Room": "images/background/retroroom.JPG",
    "Color Background 1": "images/background/biru.jpg",
    "Color Background 2": "images/background/biru1.jpg",
    "Color Background 3": "images/background/pink.jpg",
    "Color Background 4": "images/background/kunig.jpg"
  },
